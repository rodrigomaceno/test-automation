...
public class Army {
    ...
    public void createSoldiers(Soldier[] soldiers, String nation) { Arrays.setAll(soldiers, count -> new Soldier()); }
    ...
    public void createWarplanes(Warplane[] warplanes, String nation) { Arrays.setAll(warplanes, count -> new Warplane()); }
    public void createSubmarines(Submarine[] submarines, String nation) { Arrays.setAll(submarines, count -> new Submarine()); }
