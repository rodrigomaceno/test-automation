...
public class Army {
    ...
    public void setMarines(Marine[] marines) {
    ...
    public void createArmy(String nation, int numSoldiers, int numTanks) throws InvalidAmountException {
        if(numSoldiers <=0 || numTanks > 1000){
            throw new InvalidAmountException("Please choose amount between 1 and 1000");
        }
        setSoldiers(new Soldier[numSoldiers]);
        setTanks(new Tank[numTanks]);
    ...
    public void createSoldiers(Soldier[] soldiers, String nation) {
        Arrays.setAll(soldiers, count -> new Soldier(nation));
    }
    ...
    public void createWarships(Warship[] warships, String nation) {
        Arrays.setAll(warships, count -> new Warship(nation));
    }

    public void createWarplanes(Warplane[] warplanes, String nation) {
        Arrays.setAll(warplanes, count -> new Warplane(nation));
    }

    public void createSubmarines(Submarine[] submarines, String nation) {
        Arrays.setAll(submarines, count -> new Submarine(nation));
    }
